...
/**
 * Service's main resource for accessing e.g. availability and binding resources
 * 
 * @author ELETAI
 * @version 1.0
 * @created 11-syys-2014 13:31:15
 */
public abstract class ServicePlatformResource {

	public ServicePlatformResource() {
