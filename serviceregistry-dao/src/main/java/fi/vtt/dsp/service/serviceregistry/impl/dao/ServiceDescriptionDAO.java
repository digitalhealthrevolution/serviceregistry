...
public interface ServiceDescriptionDAO {
    ...
    ServiceDataDescription findDataDescription(
        String serviceId, String dataDescId)
        throws DAOGeneralSystemFault, DAONotFoundFault;

    String insertNewDataDescription(String serviceId,
        ServiceDataDescription dataDescId)
        throws DAOUpdateFailedFault, DAOGeneralSystemFault,
        DAONotSavedFault, DAONotFoundFault;

    String updateDataDescription(String serviceId,
        String dataDescId, ServiceDataDescription dataDesc)
        throws DAOGeneralSystemFault, DAOUpdateFailedFault,
        DAONotFoundFault;

    String deleteDataDescription(String serviceId,
        String dataDescId) throws DAOUpdateFailedFault,
